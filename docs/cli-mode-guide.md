...
|---|---|---|
| `search` | `<query> [--limit N]` | Hybrid semantic + full-text search (default limit: 10); obsoleted RFCs demoted by −0.10 |
...
| `ask` | `<question> [--limit N] [--keyword KW]` | Ask a question and get a cited LLM-generated answer (default limit: 10; optional `--keyword` to filter search by normative keyword) |
